  ...
  17:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  65:	50                   	push   %eax
  66:	53                   	push   %ebx
  67:	e8 47 03 00 00       	call   3b3 <chpr>
  exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 0c 08 00 00       	mov    $0x80c,%ebx
        while(*s != 0){
