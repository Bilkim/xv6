...
int main(int argc, char *argv[]) {
  ...
  27:	eb 24                	jmp    4d <main+0x4d>
    pid = fork ();
    if ( pid < 0 ) {
      printf(1, "%d failed in fork!\n", getpid());
    } else if (pid > 0) {
  29:	74 6d                	je     98 <main+0x98>
      // parent
      printf(1, "Parent %d creating child %d\n",getpid(), pid);
  2b:	e8 73 03 00 00       	call   3a3 <getpid>
  30:	56                   	push   %esi
  for ( k = 0; k < n; k++ ) {
  31:	83 c7 01             	add    $0x1,%edi
      printf(1, "Parent %d creating child %d\n",getpid(), pid);
  34:	50                   	push   %eax
  35:	68 2c 08 00 00       	push   $0x82c
  3a:	6a 01                	push   $0x1
  3c:	e8 6f 04 00 00       	call   4b0 <printf>
      wait();
  41:	e8 e5 02 00 00       	call   32b <wait>
  46:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  49:	39 fb                	cmp    %edi,%ebx
  4b:	7e 2a                	jle    77 <main+0x77>
    pid = fork ();
  4d:	e8 c9 02 00 00       	call   31b <fork>
  52:	89 c6                	mov    %eax,%esi
    if ( pid < 0 ) {
  54:	85 c0                	test   %eax,%eax
  56:	79 d1                	jns    29 <main+0x29>
      printf(1, "%d failed in fork!\n", getpid());
  58:	e8 46 03 00 00       	call   3a3 <getpid>
  ...
  exit();
  77:	e8 a7 02 00 00       	call   323 <exit>
	n = atoi(argv[1]);
  7c:	83 ec 0c             	sub    $0xc,%esp
  7f:	ff 72 04             	pushl  0x4(%edx)
  82:	e8 29 02 00 00       	call   2b0 <atoi>
  if (n < 0 ||n > 20)
  87:	83 c4 10             	add    $0x10,%esp
	n = atoi(argv[1]);
  8a:	89 c3                	mov    %eax,%ebx
  if (n < 0 ||n > 20)
  8c:	83 f8 14             	cmp    $0x14,%eax
  8f:	76 1f                	jbe    b0 <main+0xb0>
	n = 2;
  91:	bb 02 00 00 00       	mov    $0x2,%ebx
  96:	eb 8d                	jmp    25 <main+0x25>
	printf(1,"Child %d created\n",getpid());
  98:	e8 06 03 00 00       	call   3a3 <getpid>
  9d:	52                   	push   %edx
  9e:	50                   	push   %eax
  9f:	68 49 08 00 00       	push   $0x849
  a4:	6a 01                	push   $0x1
  a6:	e8 05 04 00 00       	call   4b0 <printf>
  ab:	83 c4 10             	add    $0x10,%esp
	for(z = 0; z < 4000000000; z+=1)
  ae:	eb fe                	jmp    ae <main+0xae>
  for ( k = 0; k < n; k++ ) {
  b0:	85 c0                	test   %eax,%eax
  b2:	0f 85 6d ff ff ff    	jne    25 <main+0x25>
  b8:	eb bd                	jmp    77 <main+0x77>
  ba:	66 90                	xchg   %ax,%ax
  bc:	66 90                	xchg   %ax,%ax
  be:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 5b 08 00 00       	mov    $0x85b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 685:	a1 1c 0b 00 00       	mov    0xb1c,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 1c 0b 00 00       	mov    %eax,0xb1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d 1c 0b 00 00    	mov    0xb1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d 1c 0b 00 00    	mov    0xb1c,%edi
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 1c 0b 00 00       	mov    0xb1c,%eax
 ...
 7c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7c7:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 ...
 7de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 1c 0b 00 00 20 	movl   $0xb20,0xb1c
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf 20 0b 00 00       	mov    $0xb20,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 802:	00 00 00 
    if(p->s.size >= nunits){
