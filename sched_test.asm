...
int main(int argc, char *argv[])
{
  ...
  1b:	e8 4b 04 00 00       	call   46b <getticks>
  20:	89 c6                	mov    %eax,%esi
    if (fork() == 0) {
  22:	e8 84 03 00 00       	call   3ab <fork>
  ...
  33:	e8 b3 03 00 00       	call   3eb <exec>
        exit();
  38:	e8 76 03 00 00       	call   3b3 <exit>
    } else {
        waitx(&waittime, &runtime);
  3d:	8d 4d e0             	lea    -0x20(%ebp),%ecx
  40:	8d 7d e4             	lea    -0x1c(%ebp),%edi
  43:	53                   	push   %ebx
  44:	53                   	push   %ebx
  45:	51                   	push   %ecx
  46:	57                   	push   %edi
  47:	e8 17 04 00 00       	call   463 <waitx>
    }
    end_ticks = getticks();
  4c:	e8 1a 04 00 00       	call   46b <getticks>
    total_waittime += waittime;
  51:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
    end_ticks = getticks();
  54:	89 45 d0             	mov    %eax,-0x30(%ebp)
    total_turnaround += runtime + waittime;
  57:	8b 45 e0             	mov    -0x20(%ebp),%eax
  5a:	89 45 d4             	mov    %eax,-0x2c(%ebp)

    printf(1, "\nUser Mode Statistics for uniq:\n");
  5d:	58                   	pop    %eax
  5e:	5a                   	pop    %edx
  5f:	68 f0 08 00 00       	push   $0x8f0
  64:	6a 01                	push   $0x1
  66:	e8 d5 04 00 00       	call   540 <printf>
    printf(1, "Start Time: %d\nEnd Time: %d\n", start_ticks, end_ticks);
  6b:	8b 45 d0             	mov    -0x30(%ebp),%eax
  6e:	50                   	push   %eax
  6f:	56                   	push   %esi
  70:	68 ad 08 00 00       	push   $0x8ad
  75:	6a 01                	push   $0x1
  77:	e8 c4 04 00 00       	call   540 <printf>
    printf(1, "Wait Time: %d\nRun Time: %d\n", waittime, runtime);
  7c:	83 c4 20             	add    $0x20,%esp
  7f:	ff 75 e0             	pushl  -0x20(%ebp)
  82:	ff 75 e4             	pushl  -0x1c(%ebp)
  85:	68 ca 08 00 00       	push   $0x8ca
  8a:	6a 01                	push   $0x1
  8c:	e8 af 04 00 00       	call   540 <printf>

    // Kernel Mode
    start_ticks = getticks();
  91:	e8 d5 03 00 00       	call   46b <getticks>
  96:	89 c6                	mov    %eax,%esi
    if (fork() == 0) {
  98:	e8 0e 03 00 00       	call   3ab <fork>
  9d:	83 c4 10             	add    $0x10,%esp
  a0:	8d 4d e0             	lea    -0x20(%ebp),%ecx
  a3:	85 c0                	test   %eax,%eax
  a5:	75 15                	jne    bc <main+0xbc>
        uniq(0, 0, 0, "example");
  a7:	68 e6 08 00 00       	push   $0x8e6
  ac:	6a 00                	push   $0x0
  ae:	6a 00                	push   $0x0
  b0:	6a 00                	push   $0x0
  b2:	e8 9c 03 00 00       	call   453 <uniq>
        exit();
  b7:	e8 f7 02 00 00       	call   3b3 <exit>
    } else {
        waitx(&waittime, &runtime);
  bc:	50                   	push   %eax
  bd:	50                   	push   %eax
  be:	51                   	push   %ecx
  bf:	57                   	push   %edi
  c0:	e8 9e 03 00 00       	call   463 <waitx>
    }
    end_ticks = getticks();
  c5:	e8 a1 03 00 00       	call   46b <getticks>
    total_waittime += waittime;
  ca:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    end_ticks = getticks();
  cd:	89 45 cc             	mov    %eax,-0x34(%ebp)
    total_waittime += waittime;
  d0:	8d 04 13             	lea    (%ebx,%edx,1),%eax
    total_turnaround += runtime + waittime;
  d3:	03 55 e0             	add    -0x20(%ebp),%edx
    total_turnaround += runtime + waittime;
  d6:	03 5d d4             	add    -0x2c(%ebp),%ebx
    total_turnaround += runtime + waittime;
  d9:	8d 3c 1a             	lea    (%edx,%ebx,1),%edi

    printf(1, "\nKernel Mode Statistics for uniq:\n");
  dc:	5a                   	pop    %edx
  dd:	59                   	pop    %ecx
  de:	68 14 09 00 00       	push   $0x914
  e3:	6a 01                	push   $0x1
    printf(1, "Start Time: %d\nEnd Time: %d\n", start_ticks, end_ticks);
    printf(1, "Wait Time: %d\nRun Time: %d\n", waittime, runtime);
  ...
  e5:	bb 02 00 00 00       	mov    $0x2,%ebx
    total_waittime += waittime;
  ea:	89 45 d0             	mov    %eax,-0x30(%ebp)
    printf(1, "\nKernel Mode Statistics for uniq:\n");
  ed:	e8 4e 04 00 00       	call   540 <printf>
    printf(1, "Start Time: %d\nEnd Time: %d\n", start_ticks, end_ticks);
  f2:	8b 4d cc             	mov    -0x34(%ebp),%ecx
  f5:	51                   	push   %ecx
  f6:	56                   	push   %esi
  f7:	68 ad 08 00 00       	push   $0x8ad
  fc:	6a 01                	push   $0x1
  fe:	e8 3d 04 00 00       	call   540 <printf>
    printf(1, "Wait Time: %d\nRun Time: %d\n", waittime, runtime);
 103:	83 c4 20             	add    $0x20,%esp
 106:	ff 75 e0             	pushl  -0x20(%ebp)
 109:	ff 75 e4             	pushl  -0x1c(%ebp)
 10c:	68 ca 08 00 00       	push   $0x8ca
 111:	6a 01                	push   $0x1
 113:	e8 28 04 00 00       	call   540 <printf>
    printf(1, "\nAverage Wait Time across both modes: %d\n", total_waittime / 2);
 118:	8b 45 d0             	mov    -0x30(%ebp),%eax
 11b:	83 c4 0c             	add    $0xc,%esp
 11e:	99                   	cltd   
 11f:	f7 fb                	idiv   %ebx
 121:	50                   	push   %eax
 122:	68 38 09 00 00       	push   $0x938
 127:	6a 01                	push   $0x1
 129:	e8 12 04 00 00       	call   540 <printf>
 ...
 13c:	6a 01                	push   $0x1
 13e:	e8 fd 03 00 00       	call   540 <printf>
 143:	83 c4 10             	add    $0x10,%esp

    // [Additional CPU Load]
    for(z = 0; z < 40000000000; z+=1){
 146:	eb fe                	jmp    146 <main+0x146>
...
printf(int fd, const char *fmt, ...)
{
 ...
 6c4:	eb 1a                	jmp    6e0 <printf+0x1a0>
          s = "(null)";
 6c6:	bb 93 09 00 00       	mov    $0x993,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 715:	a1 50 0c 00 00       	mov    0xc50,%eax
{
 ...
 736:	73 10                	jae    748 <free+0x38>
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	a3 50 0c 00 00       	mov    %eax,0xc50
}
 767:	5e                   	pop    %esi
 768:	5f                   	pop    %edi
 769:	5d                   	pop    %ebp
 ...
 787:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 78a:	a3 50 0c 00 00       	mov    %eax,0xc50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7b0:	8b 3d 50 0c 00 00    	mov    0xc50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7f9:	8b 3d 50 0c 00 00    	mov    0xc50,%edi
 ...
 822:	e8 e9 fe ff ff       	call   710 <free>
  return freep;
 827:	a1 50 0c 00 00       	mov    0xc50,%eax
 ...
 854:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 857:	a3 50 0c 00 00       	mov    %eax,0xc50
}
 ...
 877:	0c 00 00 
    base.s.size = 0;
 87a:	bf 54 0c 00 00       	mov    $0xc54,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 54 0c 00 00 54 	movl   $0xc54,0xc54
 886:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
