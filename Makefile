...
PRINT = runoff.list runoff.spec README example toc.hdr toc.ftr $(FILES)
...
EXTRA=\
	...
	ln.c ls.c mkdir.c null.c prc.c ps.c rm.c scd.c stressfs.c sched_test.c test.c test2.c usertests.c wc.c zombie.c uniq.c head.c\
	printf.c umalloc.c\
