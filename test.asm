...
int main(int argc, char *argv[])
{
  ...
  1b:	e8 0b 04 00 00       	call   42b <getticks>
  20:	89 c3                	mov    %eax,%ebx

    // Execute uniq command
    if (fork() == 0) {
  22:	e8 44 03 00 00       	call   36b <fork>
  ...
  2c:	50                   	push   %eax
  2d:	56                   	push   %esi
  2e:	68 58 08 00 00       	push   $0x858
  33:	e8 73 03 00 00       	call   3ab <exec>
        exit();
  38:	e8 36 03 00 00       	call   373 <exit>
    } else {
        waitx(&waittime, &runtime);
  3d:	8d 55 e0             	lea    -0x20(%ebp),%edx
  40:	8d 7d e4             	lea    -0x1c(%ebp),%edi
  43:	50                   	push   %eax
  44:	50                   	push   %eax
  45:	52                   	push   %edx
  46:	57                   	push   %edi
  47:	e8 d7 03 00 00       	call   423 <waitx>
    }

    // Get the ending tick count for uniq
    end_ticks = getticks();
  4c:	e8 da 03 00 00       	call   42b <getticks>
  51:	89 45 d4             	mov    %eax,-0x2c(%ebp)

    printf(1, "\n");
  54:	58                   	pop    %eax
  55:	5a                   	pop    %edx
  56:	68 8c 08 00 00       	push   $0x88c
  5b:	6a 01                	push   $0x1
  5d:	e8 8e 04 00 00       	call   4f0 <printf>
    printf(1, "Statistics for uniq:\n");
  62:	59                   	pop    %ecx
  63:	58                   	pop    %eax
  64:	68 5d 08 00 00       	push   $0x85d
  69:	6a 01                	push   $0x1
  6b:	e8 80 04 00 00       	call   4f0 <printf>
    printf(1, "Start Time: %d\nEnd Time: %d\nTotal Time: %d\n", start_ticks - (runtime + waittime), end_ticks, runtime + waittime);
  70:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  73:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  76:	03 4d e0             	add    -0x20(%ebp),%ecx
  79:	29 cb                	sub    %ecx,%ebx
  7b:	89 0c 24             	mov    %ecx,(%esp)
  7e:	50                   	push   %eax
  7f:	53                   	push   %ebx
  80:	68 90 08 00 00       	push   $0x890
  85:	6a 01                	push   $0x1
  ...
  8f:	e8 97 03 00 00       	call   42b <getticks>
  94:	89 c3                	mov    %eax,%ebx

    // Execute head command
    if (fork() == 0) {
  96:	e8 d0 02 00 00       	call   36b <fork>
  9b:	8d 55 e0             	lea    -0x20(%ebp),%edx
  9e:	85 c0                	test   %eax,%eax
  a0:	75 12                	jne    b4 <main+0xb4>
        exec("head", argv);
  a2:	50                   	push   %eax
  a3:	50                   	push   %eax
  a4:	56                   	push   %esi
  a5:	68 73 08 00 00       	push   $0x873
  aa:	e8 fc 02 00 00       	call   3ab <exec>
        exit();
  ...
  b6:	52                   	push   %edx
  b7:	57                   	push   %edi
  b8:	e8 66 03 00 00       	call   423 <waitx>
    }

    // Get the ending tick count for head
    end_ticks = getticks();
  bd:	e8 69 03 00 00       	call   42b <getticks>
  ...
  d2:	5f                   	pop    %edi
  d3:	58                   	pop    %eax
  d4:	68 78 08 00 00       	push   $0x878
  d9:	6a 01                	push   $0x1
  db:	e8 10 04 00 00       	call   4f0 <printf>
    printf(1, "Start Time: %d\nEnd Time: %d\nTotal Time: %d\n", start_ticks - (runtime + waittime), end_ticks, runtime + waittime);
  e0:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  e3:	03 55 e0             	add    -0x20(%ebp),%edx
  e6:	29 d3                	sub    %edx,%ebx
  e8:	89 14 24             	mov    %edx,(%esp)
  eb:	56                   	push   %esi
  ec:	53                   	push   %ebx
  ed:	68 90 08 00 00       	push   $0x890
  f2:	6a 01                	push   $0x1
  f4:	e8 f7 03 00 00       	call   4f0 <printf>
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb bc 08 00 00       	mov    $0x8bc,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c5:	a1 78 0b 00 00       	mov    0xb78,%eax
{
 ...
 6e6:	73 10                	jae    6f8 <free+0x38>
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	a3 78 0b 00 00       	mov    %eax,0xb78
}
 717:	5e                   	pop    %esi
 718:	5f                   	pop    %edi
 719:	5d                   	pop    %ebp
 ...
 737:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 73a:	a3 78 0b 00 00       	mov    %eax,0xb78
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 75d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 760:	8b 3d 78 0b 00 00    	mov    0xb78,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7a9:	8b 3d 78 0b 00 00    	mov    0xb78,%edi
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 78 0b 00 00       	mov    0xb78,%eax
 ...
 804:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 807:	a3 78 0b 00 00       	mov    %eax,0xb78
}
 ...
 81e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 78 0b 00 00 7c 	movl   $0xb7c,0xb78
 827:	0b 00 00 
    base.s.size = 0;
 82a:	bf 7c 0b 00 00       	mov    $0xb7c,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 7c 0b 00 00 7c 	movl   $0xb7c,0xb7c
 836:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 83b:	c7 05 80 0b 00 00 00 	movl   $0x0,0xb80
 842:	00 00 00 
    if(p->s.size >= nunits){
