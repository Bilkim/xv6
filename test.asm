 ...
 45c:	89 d1                	mov    %edx,%ecx
{
 ...
 489:	0f b6 92 d4 08 00 00 	movzbl 0x8d4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb cc 08 00 00       	mov    $0x8cc,%ebx
        while(*s != 0){
